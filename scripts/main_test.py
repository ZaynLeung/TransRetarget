...
if __name__ == "__main__":
    if data_tpye == 'visionpro':
        input_dir = f'/home/ub/TransHandR/dataset/data/h5/glove_data_aligned.h5'
        ...
        out_dir = f'/home/ub/TransHandR/output/h5/{hand_brand}/{hand_brand}_output.h5'
        ...
        model_path=f'/home/ub/TransHandR/checkpoint/models/{ab_experiment_name}/{hand_brand}/model_final.pth'
        # model_path=f'D:\\2026\\code\\TransHandR\\TransHandR\\checkpoint\\models\\None\\{hand_brand}\\model_final.pth'
        keys = None
    else:
        input_dir = f'/home/ub/TransHandR/dataset/data/h5/sign_glove_aligned.h5'
        out_dir = f'/home/ub/TransHandR/output/h5/slahmr/{hand_brand}/{hand_brand}_slahmr_output.h5'
        model_path=f'/home/ub/TransHandR/checkpoint/models/slahmr/{hand_brand}/model_final.pth'
