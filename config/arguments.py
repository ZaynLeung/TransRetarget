...
def parse_args():
    ...
    # dataset arguments
    parser.add_argument('-ht', '--hand-type', default='right', type=str, metavar='NAME', help='hand type: left, right, or both')
    # General arguments
    parser.add_argument('-d', '--dataset', default='h5', type=str, metavar='NAME', help='target dataset') # h36m or humaneva
    parser.add_argument('-k', '--keypoints', default='glove_data', type=str, metavar='NAME', help='2D detections to use')
    parser.add_argument('-str', '--subjects-train', default='测试-ceshi,S5,S6,S7,S8', type=str, metavar='LIST',
                        help='training subjects separated by comma')
    parser.add_argument('-ste', '--subjects-test', default='测试-ceshi,S11', type=str, metavar='LIST', help='test subjects separated by comma')
    ...
    parser.add_argument('-e', '--epochs', default=300, type=int, metavar='N', help='number of training epochs')
    ...
    parser.add_argument('-frame', '--number-of-frames', default='3', type=int, metavar='N',
